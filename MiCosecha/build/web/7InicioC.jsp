       ...
       <div class="row no-gutters bg-dark">
           ...
           <div class="col-xl-7 col-lg-12 d-flex">
                <div class="container align-self-center p-6">
                    <h1 class="font-weight-bold mb-3">Inicia Sesion Comprador</h1>
                    <p class="text-muted mb-5">Ingresa la siguiente informacion para Iniciar. si No tienes cuenta ingresa <a href="1Bienvenida.jsp">aqui</a> Sino <a href="1Bienvenida.jsp">aqui</a></p>
                   <form action="IniciarC"  class="formulario" id="formulario" method="post" >
