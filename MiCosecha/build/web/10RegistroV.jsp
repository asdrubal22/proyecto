       ...
       <div class="row no-gutters bg-dark">
           ...
           <div class="col-xl-7 col-lg-12 d-flex">
                <div class="container align-self-center p-6">
                    <h1 class="font-weight-bold mb-3">Registrate Vendedor</h1>
                    <p class="text-muted mb-5">Ingresa la siguiente informacion para Iniciar. si ya tienes cuenta ingresa <a href="8InicioV.jsp">aqui</a> Sino <a href="1Bienvenida.jsp">aqui</a></p>
                   <form action="RegistroV" class="formulario" id="formulario" method="POST">
			...
			<div class="form-group col-md-6">
                        ...
                        <button type="submit" value = "Registrarme" class="btn btn-primary width-100" name="ingresoV">Registrate</button>
                    </form>
