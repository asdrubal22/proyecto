                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-menu">
                        <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="17cama.jsp">cama de cultivo y huerto</a></li>
            ...
            <ul class="slides-container">
                ...
                <li class="text-center">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="m-b-20"><strong>Mira los pasos. </strong></h1>
                            </div>
                        </div>
                    </div>
                </li>
                <li class="text-center">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="m-b-20"><strong>1 Capa de piedras</strong></h1>
                ...
                <li class="text-center">
                    <img src="images/cama1.jpg" alt="">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="m-b-20"><strong>2 Capa de arena</strong></h1>
                            </div>
                        </div>
                    </div>
                </li>
                <li class="text-center">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="m-b-20"><strong>3 capa de tierra y abono</strong></h1>
                            </div>
                        </div>
                    </div>
                </li>
                 ...
                 <li class="text-center">
                    <img src="images/cama3.jpg" alt="">
                   
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="m-b-20"><strong>Puedes sembrar semillas o plantar plantones.</strong></h1>
                            </div>
                        </div>
                    </div>
                </li>
                ...
                <li class="text-center">
                    <img src="images/cama4.jpg" alt="">
                   
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="m-b-20"><strong>Riega generosamente para que las semillas o plantones se asienten bien.</strong></h1>
                            </div>
                        </div>
                    </div>
                </li>
            ...
            <div class="main-instagram owl-carousel owl-theme">
                <div class="item">
                    <div class="ins-inner-box">
                        <img src="images/ImaInferiores/cama/ima1.jpg" alt="" />
                 ...
                 <div class="item">
                    <div class="ins-inner-box">
                        <img src="images/ImaInferiores/cama/ima2.jpg" alt="" />
                ...
                <div class="item">
                    <div class="ins-inner-box">
                        <img src="images/ImaInferiores/cama/ima3.jpg" alt="" />
                ...
                <div class="item">
                    <div class="ins-inner-box">
                        <img src="images/ImaInferiores/cama/ima4.jpg" alt="" />
                 ...
                 <div class="item">
                    <div class="ins-inner-box">
                        <img src="images/ImaInferiores/cama/ima5.jpg" alt="" />
                ...
                <div class="item">
                    <div class="ins-inner-box">
                        <img src="images/ImaInferiores/cama/ima6.jpg" alt="" />
                 ...
                 <div class="item">
                    <div class="ins-inner-box">
                        <img src="images/ImaInferiores/cama/ima7.jpg" alt="" />
                ...
                <div class="item">
                    <div class="ins-inner-box">
                        <img src="images/ImaInferiores/cama/ima8.jpg" alt="" />
               ...
               <div class="item">
                    <div class="ins-inner-box">
                        <img src="images/ImaInferiores/cama/ima9.jpg" alt="" />
                ...
                <div class="item">
                    <div class="ins-inner-box">
                        <img src="images/ImaInferiores/cama/ima10.jpg" alt="" />
