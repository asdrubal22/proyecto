                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">       
                        <div class="our-link">
                            <ul>
                                    ...
                                    <li><a href="6Inicios.jsp" ><i class="fa fa-user s_color"></i>Inicar Sesion</a></li>
                                    <li><a href="5Inicios.jsp" ><i class="fas fa-location-arrow"></i>Registrarse</a></li>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-menu">
                        <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                            <li class="nav-item "><a class="nav-link" href="3ComComprar.jsp">Comprar</a></li>
                            <li class="nav-item active"><a class="nav-link" href="4ComIntercambiar.jsp">Intercambiar</a></li>
                            <li class="dropdown">        
                            </li>
                            <li class="nav-item"><a class="nav-link" href="1Bienvenida.jsp">Atras</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
        ...
        <div id="slides-shop" class="cover-slides">
            <ul class="slides-container">
                <li class="text-center">
                    <img src="images/sustrato13.jpg" alt="">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="m-b-20"><strong>Residuos organicos en buen estado<br>(sirve como abono)</strong></h1>
                            </div>
                        </div>
                    </div>
                </li>
                <li class="text-center">
                    <img src="images/canas8.jpg" alt="">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="m-b-20"><strong>botellas de plastico<br>(Sirven como macetas)</strong></h1>
                            </div>
                        </div>
                    </div>
                </li>
               <li class="text-center">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="m-b-20"><strong>Otras plantas</strong></h1>
                            </div>
                        </div>
                    </div>
                </li>
                 <li class="text-center">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="m-b-20"><strong>Verduras</strong></h1>
                            </div>
                        </div>
                    </div>
                </li>
                <li class="text-center">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="m-b-20"><strong>Alimentos</strong></h1>
                            </div>
                        </div>
                    </div>
                </li>
                 <li class="text-center">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="m-b-20"><strong>Objetos<br>Que favorescan al agricultor.</strong></h1>
                            </div>
                        </div>
                    </div>
                </li>
